...
PRED_MIN_MARGIN = 0.05   # adjust upward to require clearer separation between levels
...
WORD_BANKS = {
    "cat": {
        "local": {
            "identity":       ["bruno", "red hair", "redhead", "ginger"],
            "cat_state":      ["dirty", "stinky", "yucky", "rain", "wet", "cold", "shaking",
                               "stray", "street", "nobody wanted"],
